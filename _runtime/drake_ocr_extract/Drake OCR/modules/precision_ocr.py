...
from modules.sonic_log_renderer import render_sonic_log_html
...
BLUEPRINTS = {
    ...
    "Well Log OCR (Oil & Gas)": {
        "identity": "You are an elite geophysical document OCR engine, specialized in extracting structured data from oil & gas Well Log header sheets — including Sonic Logs, Gamma Ray Logs, Resistivity Logs, and similar borehole survey forms. These documents are often scanned, faxed, or photocopied, and may be blurry, rotated, or partially degraded.",
        "structure": """\
---
## FILING INFORMATION
**Filing No:** [value]
...
**County:** [value]
**State:** [value]
**Location:** [TWP] [RNG] [SEC] [values as printed]
...
**Elev (DF):** [value]
**Elev (GL):** [value]
**Permanent Datum:** [value]
**Drilling Measured From:** [value]
**Log Measured From:** [value]

## LOG INTERVAL
**Bottom Logged Interval:** [value]
**Top Logged Interval:** [value]
**Depth — Driller:** [value]
**Depth — Logger:** [value]
**Run No:** [value]
**Date:** [value]
...
**Fluid in Hole:** [value]
**Fluid Level:** [value]
**Max Rec Temp (Deg F):** [value]
**PPM Cl:** [value]

## TIMING & OPERATIONS
**Operating Rig Time:** [value]
**Hours:** [value]
**Eq No / Rig Location:** [value]
...
## RUN LOG TABLE
| Run | Date | Witnessed By | Bore Hole Record | Temp | Hours | Size/Rig |
|-----|------|-------------|-----------------|------|-------|----------|
| [values from image rows] | ... | ... | ... | ... | ... | ... |

## RECEIVED / STAMPS
**Received By:** [agency name as printed]
**Date Received:** [value]
**Conservation Division / State Corp Commission:** [as printed]

## ADDITIONAL NOTES
[Any other text, stamps, annotations, or handwritten marks visible in the image]
---""",
        "instructions": "MANDATORY FULL EXTRACTION: Transcribe EVERY field label and its corresponding handwritten or typed value. Do not skip any row or box, even if the value appears blank — output [blank] for empty fields.",
        "rules": "2. EXACT VALUE FIDELITY: Copy numbers, codes, abbreviations, and units exactly as they appear. Never normalize, round, or interpret. If the image shows '8/28/91', output '8/28/91' — not 'August 28, 1991'.\n3. LOCATION CODES: For the Location field, preserve the full Township/Range/Section notation exactly as printed (e.g., 'NW NW NW SEC 17 TWP 42S RNG 043W 100A').\n4. HANDWRITING PRIORITY: Where both printed labels and handwritten values exist, capture both. Handwritten values that are uncertain should be marked with [?] (e.g., '264[?]').\n5. ROTATED / SIDEWAYS TEXT: The Filing No and document title often appear rotated 90 degrees on the right margin. Extract these regardless of orientation.\n6. STAMPS & RECEIVED BOXES: All rubber stamps, 'RECEIVED' boxes, commission seals, and dates must be captured under 'RECEIVED / STAMPS'.\n7. NUMERIC PRECISION: Preserve all depth values, temperatures, PPM readings, and elevation numbers exactly — including decimal points and units.\n8. TABLE ROWS: The Run Log table at the bottom may contain 1–5 rows of handwritten data. Extract all rows into the Markdown table.\n9. BLURRY / DEGRADED TEXT: If a character is ambiguous, output your best reading followed by [?] (e.g., '264[?]'). Never skip a field due to poor image quality.\n10. NO PREAMBLE OR COMMENTARY: Begin your output immediately with '---'. Do not add greetings, explanations, or summaries."
    },
    "LDSL Diagnostics": {
...
|------|-------------|---------|----------------|-------------|------------|-----------|----------|-----------------|""",
    ...
    "Sonic Log / Well Log": {
        "identity": (
            "You are an elite geophysical document OCR engine specialized in "
            "oil & gas Well Log header sheets — Sonic Logs, Gamma Ray Logs, "
            "Resistivity Logs, and borehole survey forms. These are often scanned, "
            "faxed, or photocopied and may be blurry, rotated, or degraded."
        ),
        "structure": """\
FILING_NO: [value]
LOG_TYPE: [value]
TYPE_LOG: [value or BLANK]
...
COUNTY: [value]
STATE: [value]
LOCATION: [full TWP/RNG/SEC string exactly as printed]
API: [value or BLANK]
SEC: [value]
TWP: [value]
RGE: [value]

PERMANENT_DATUM: [value]
LOG_MEASURED_FROM: [value]
DRILLING_MEASURED_FROM: [value]
GROUND_LEVEL: [value]
ELEV_KF: [value or BLANK]
ELEV_KB: [value]
ELEV_DF: [value]
ELEV_GL: [value or BLANK]

DATE: [value]
RUN_NO: [value]
TYPE_LOG_RUN: [value]
DEPTH_DRILLER: [value]
DEPTH_LOGGER: [value or BLANK]
BOTTOM_LOGGED_INTERVAL: [value]
TOP_LOGGED_INTERVAL: [value]
TYPE_FLUID_IN_HOLE: [value]
SALINITY_PPM_CL: [value]
DENSITY: [value or BLANK]
LEVEL: [value]
MAX_REC_TEMP_DEG_F: [value]
OPERATING_RIG_TIME: [value]
EQUIP_NO_LOCATION: [value]
RECORDED_BY: [value]
WITNESSED_BY: [value]

OTHER_SERVICES_1: [value or BLANK]
OTHER_SERVICES_2: [value or BLANK]
DUAL_IND_DUAL: [value or BLANK]

RECEIVED_BY_AGENCY: [value or BLANK]
DATE_RECEIVED: [value]
COMMISSION_NAME: [value]
CONSERVATION_DIVISION: [value or BLANK]
CONSERVATION_OFFICER: [value or BLANK]

RUN_TABLE:
| Run No | Bit | Bore Hole From | Bore Hole To | Size | Wgt | Casing From | Casing To |
|--------|-----|----------------|--------------|------|-----|-------------|-----------|
| [val]  | [val] | [val or BLANK] | [val or BLANK] | [val or BLANK] | [val or BLANK] | [val or BLANK] | [val or BLANK] |

ADDITIONAL_STAMPS: [any rubber stamps, handwritten annotations, or extra marks]""",
        "instructions": (
            "MANDATORY: Extract EVERY field from the form. "
            "For any field that is blank in the image, output the word BLANK — never skip a field. "
            "Preserve all numbers, codes, dates, and abbreviations exactly as printed or handwritten. "
            "Extract the Run Table with ALL rows that contain data. "
            "Extract the RECEIVED stamp box fully including date and officer name. "
            "Extract the Filing No even if it appears rotated 90 degrees on the margin."
        ),
        "rules": (
            "2. EXACT VALUE FIDELITY: Never normalize dates or numbers. "
            "'8/28/91' stays '8/28/91' — not 'August 28, 1991'.\n"
            "3. LOCATION CODES: Preserve the full Township/Range/Section notation exactly "
            "(e.g., NW NW NW SEC 17 TWP 2S RGE 14W).\n"
            "4. ROTATED TEXT: The Filing No and document title may appear rotated 90 degrees "
            "on the right or left margin — extract them regardless of orientation.\n"
            "5. STAMPS: All rubber stamps, RECEIVED boxes, commission seals, and dates must "
            "be captured under RECEIVED_BY_AGENCY and related fields.\n"
            "6. BLURRY TEXT: If a character is ambiguous, output your best reading followed "
            "by [?] (e.g., '264[?]'). Never skip a field due to poor image quality.\n"
            "7. RUN TABLE: Extract every row that has any data. Empty rows output as BLANK.\n"
            "8. NO PREAMBLE: Start output directly with FILING_NO:. No greetings."
        ),
    },
}
    ...
    if st.session_state.ocr_combined:
        ...
        with col_res:
            ...
            if len(st.session_state.ocr_pages) > 1:
                ...
                with tab1:
                    if st.session_state.get("ocr_client") == "Sonic Log / Well Log":
                        html_output = render_sonic_log_html(st.session_state.ocr_combined)
        ...
        # Idle state
        st.info(
            "📋 Upload a document (image or PDF) in the sidebar and click "
            "**Extract Data** to begin. Supports medical forms, well log headers, "
            "invoices, and any scanned document."
        )
